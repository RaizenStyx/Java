...
public class RandomEncounterDriver {
    ...
    public static void main(String[] args) {
        ...
        final short NUM_ENCOUNTERS = 10;  //number of encounters to generate
        final short MIN_MONSTERS = 4;   //minimum number of monsters to generator per encounter
